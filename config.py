...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002492972516"))
# NAMA OWNER
...
START_PIC = os.environ.get("START_PIC", "https://envs.sh/m5X.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://envs.sh/m5M.jpg")
